...
const styles = theme => {
	const homeTransition = `${theme.transitions.duration}ms ${theme.transitions.easing.easeInOut}`;
	return {
		home: {
			minHeight: '100vh',
			textAlign: 'center',
		...
		<div className={ homeClass }>
			<div className={ classes.revealer }>
				<Paper elevation={elevation} className={classes.paperRoot}>
					...
					<p className={ classes.subHeading }>YouTube-Powered<br />Karaoke Party</p>
